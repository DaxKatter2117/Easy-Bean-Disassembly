...
Str_PressStart:	
	include "resource/text/Title/Press Start.asm"
	
Str_CompileCpy:
	include "resource/text/Title/Compile.asm"
	
Str_SegaCpy:
	include "resource/text/Title/Sega.asm"
...
Title_LoadFG:
	include "src/subroutines/title/Load Foreground.asm"

; =============== S U B	R O U T	I N E =======================================

Title_LoadBG:
	include "src/subroutines/title/Load Background.asm"
